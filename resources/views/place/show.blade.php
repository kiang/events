        ...
        <div id="app">
            <main class="container">
                <h1 class="text-center">
                    ...
                    <a href="https://www.google.com/maps/dir/?api=1&destination={{ $place->latitude }},{{ $place->longitude }}&travelmode=driving" target="_blank">{{ $place->name }}</a>
                    @else
                    {{ $place->name }}
                    @endif
                </h1>
